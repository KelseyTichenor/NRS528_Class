...
#     if folder_name == "draft_code" or folder_name == "includes" or folder_name == "layouts" or folder_name == "site":
#       print("Yay, making this directory worked!")
#     elif folder_name == "pending" or folder_name == "complete" or folder_name == "default" or folder_name == "post" or folder_name == "posted":
